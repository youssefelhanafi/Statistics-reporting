...
function sql0v5($db,$selected_val,$time1,$time2,$unite,$manager,$dga,$direction){
    $sql0v5 = "SELECT distinct 
            cat.name AS 'CATEGORIE',c.fullname AS 'FORMATION', c.visible as 'VISIBILITE',
            CASE 
              WHEN gi.itemtype = 'course' 
               THEN CONCAT('Total des activités')
            ...
            order by c.id,u.id limit 5000";
            $query0 = $db->query($sql0v5);

            return array($query0,$sql0v5);
}

function sql0v6($db,$selected_val,$time3,$time4,$unite,$manager,$dga,$direction){
    $sql0v6 = "SELECT distinct 
            cat.name AS 'CATEGORIE',c.fullname AS 'FORMATION', c.visible as 'VISIBILITE',
            CASE 
              WHEN gi.itemtype = 'course' 
               THEN CONCAT('Total des activités')
            ...
            order by c.id,u.id limit 5000";
            $query0 = $db->query($sql0v6);

            return array($query0,$sql0v6);
}
